...
[Leetcode Link](https://leetcode.cn/problems/jump-game-ii/)
...
class Solution:
    def jump(self, nums: List[int]) -> int:
        res, curjump, maxjump = 0, 0, 0   ## curjump is to record the maximum current jump distance, once reached, then the curjump ended.  
        for i in range(len(nums)-1):
            maxjump = max(maxjump, i + nums[i])
            if i == curjump:
                res += 1
                curjump = maxjump
            # print(i,curjump,maxjump)
        return res

## study cases
## input : [2,3,0,1,4]
# i res curjump maxjump
# 0 1 2 2
# 1 1 2 4
# 2 2 4 4
# 3 2 4 4
