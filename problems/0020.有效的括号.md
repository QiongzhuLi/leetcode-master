...
## My code
<br><br>
<details> <summary> <b>First try failed (didn't take '{()}' into consideration) <b> </summary>
...
class Solution:
    def isValid(self, s: str) -> bool:
        ...
        if n % 2 != 0:
            return False
        elif all(self.isPair(s[i],s[i+1]) for i in range(0,n,2)):
            return True
        else:
            return False
...
class Solution:
    def isValid(self, s: str) -> bool:
        ...
        for i,v in enumerate(s):
            if v in '{([':
                stack.append(v)
            elif stack !=[] and pairs[v] == stack[-1]:
                stack.pop()
            else:
                return False
